...
import { UploadFilled, Tools, DeleteFilled } from '@element-plus/icons-vue';
                ...
                <el-form ref="formRef" :model="dynamicValidateForm" label-width="auto" class="demo-dynamic">
                    ...
                    >
                        <div class="item-wrapper">
                            <el-input class="input-left" v-model="item.value" />
                            <el-input class="input-right" v-model="item.value" />
                            <el-icon class="input-btn" color="#d24545a3" title="删除类目" @click.prevent="removeFormIten(item)"><DeleteFilled /></el-icon>
                        </div>
                    </el-form-item>
                    <el-form-item>
                        <el-button @click="addFormIten">新增类目</el-button>
                    </el-form-item>
                </el-form>
            </template>
            <template #footer>
