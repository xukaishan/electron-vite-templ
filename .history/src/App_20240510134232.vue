        ...
        <el-drawer v-model="show" title="设置" direction="ltr" size="70%">
            <template #default>
                <el-form ref="formRef" :model="dynamicValidateForm" label-width="auto" class="demo-dynamic">
                    <el-form-item>
                        <el-button @click="addFormIten" title="新增类目" :icon="Plus" circle />
                    </el-form-item>
                    <el-form-item
                    ...
                    >
                        <div class="item-wrapper">
                            ...
                            <el-icon class="input-add" color="#d24545a3" title="删除类目" @click.prevent="removeFormIten(item)"><DeleteFilled /></el-icon>
                        </div>
                    </el-form-item>
